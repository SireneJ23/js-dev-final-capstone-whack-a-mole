...
function endGame() {
  ...
  if (difficultySelect.value === "easy") {
    ...
    targetScore = 550; // Defaults to Hard
  }
  // ----------------------------------
...
function applyDifficultySettings(level) {
  ...
  console.log(`Target score for this round: ${targetScore}`);
}
...
if (exitBut) {
  exitBut.addEventListener("click", () => {
    // Option A: Send them to a different site (like Google or your portfolio)
    window.location.href = "https://www.google.com";

    // OR Option B: Just refresh the page to reset everything
    // location.reload();
  });
}
